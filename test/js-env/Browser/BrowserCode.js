...
function GetWindowCode() {
    ...
    code += fs.readFileSync(`${__dirname}/URL/URLSearchParams.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/URL/URL.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/Blob/Blob.js`) + '\r\n';
    ...
    code += fs.readFileSync(`${__dirname}/EventTarget/Worker/Worker.js`) + '\r\n';
    ...
    // ----------------------------------------------实例化浏览器中的对象-----------------------------------------------------------------
    code += fs.readFileSync(`${__dirname}/WindowEnv.js`) + '\r\n';
...
function GetWorkerCode() {
    ...
    code += fs.readFileSync(`${__dirname}/MutationObserver/MutationObserver.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/XPathResult/XPathResult.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/StorageBucketManager/StorageBucketManager.js`) + '\r\n';
    ...
    code += fs.readFileSync(`${__dirname}/EventTarget/WindowControlsOverlay/WindowControlsOverlay.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/EventTarget/XRSystem/XRSystem.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/EventTarget/Worker/WorkerNavigator.js`) + '\r\n';

    // ---------------------------------------------------Window--------------------------------------------------------------------
    code += fs.readFileSync(`${__dirname}/EventTarget/Worker/WorkerLocation.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/EventTarget/Worker/WorkerGlobalScope.js`) + '\r\n';
    code += fs.readFileSync(`${__dirname}/EventTarget/Worker/DedicatedWorkerGlobalScope.js`) + '\r\n';
    ...
    // ----------------------------------------------实例化浏览器中的对象-----------------------------------------------------------------
    code += fs.readFileSync(`${__dirname}/WorkerEnv.js`) + '\r\n';

    return code;
}

module.exports = {
    GetWindowCode, GetWorkerCode
}