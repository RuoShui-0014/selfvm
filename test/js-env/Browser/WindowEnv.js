!function () {
    ...
    rsvm.RsSetPrivateProperty(globalThis, "__memory__", rsvm.prototype.window.memory);
    Object.defineProperties(globalThis, {
        ...
        btoa: {
            value: rsvm.RsCreateWindowAction("btoa", 1, function btoa() {
                ...
                return rsvm.btoa.applySync(null, [arguments[0]]);
            }), writable: true, enumerable: true, configurable: true
        },
        ...
        postMessage: {
            value: rsvm.RsCreateWindowAction("postMessage", 1, function postMessage() {
                // 如果是worker子线程环境，则通过rsvm.RsWorkerPostMessageToParent将数据发送到主线程，反之rsvm.RsPostMessage
                if (rsvm.isWorker){
                    rsvm.RsWorkerPostMessageToParent.apply(this, arguments);
                }else{
                    rsvm.RsPostMessage.apply(this, arguments);
                }
            }), writable: true, enumerable: true, configurable: true
        },
        print: {
